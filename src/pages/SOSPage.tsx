...
const SOSPage = () => {
  ...
  const emergencyContacts = [
    { name: "Local Emergency Services", phone: "911", relation: "Service", status: "notified" },
    { name: "John Doe", phone: "+1 (555) 123-4567", relation: "Spouse", status: "notified" },
    { name: "Dr. Sarah Chen", phone: "+1 (555) 987-6543", relation: "Primary Doctor", status: "notified" }
  ];
