      ...
      <Card variant="elevated" className="overflow-hidden">
        <CardHeader className="pb-3 bg-secondary/50">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-1 bg-trust/20 px-3 py-1.5 rounded-full">
              <Star className="text-trust fill-trust" size={18} />
              <span className="font-bold text-foreground">{rating.averageScore.toFixed(1)}</span>
