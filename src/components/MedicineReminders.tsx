...
const MedicineReminders = () => {
  const { reminders, removeReminder, toggleReminder, addReminder } = useReminderStore();
    ...
    <Card className="border-primary/10 shadow-sm overflow-hidden">
      <CardHeader className="bg-primary/5 border-b flex flex-row items-center justify-between py-4">
        <div className="flex items-center gap-2">
          ...
          <div>
            <CardTitle className="text-lg">Medicine Schedule</CardTitle>
            <p className="text-xs text-muted-foreground">Stay on track with your health</p>
          </div>
        </div>
        <Button 
          variant="outline" 
