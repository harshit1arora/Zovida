        ...
        <div className="absolute inset-0 w-[100vw] h-full" style={{ width: containerRef.current?.offsetWidth }}>
          ...
          <div className="absolute inset-0 pointer-events-none">
            ...
            <motion.div 
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              className="absolute top-[20%] left-[15%] w-[30%] h-[15%] border-2 border-primary/60 bg-primary/10 rounded-lg backdrop-blur-[2px]"
            >
            ...
            <motion.div 
              ...
              className="absolute top-[45%] left-[40%] w-[35%] h-[12%] border-2 border-danger/60 bg-danger/10 rounded-lg backdrop-blur-[2px]"
            >
              <div className="absolute -bottom-6 right-0 flex items-center gap-1.5 px-2 py-0.5 bg-danger rounded-full text-[9px] font-bold text-white shadow-lg">
                <AlertCircle size={10} />
                HIGH RISK DETECTED
              </div>
            </motion.div>
